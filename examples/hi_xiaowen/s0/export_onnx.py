...
# 输入固定的ONNX模型
def StaticOnnx():
    #"--checkpoint","/home/hlj/wekws/speech_charctc_kws_phone-xiaoyun/unittest/test_kws_training/avg_10.pt",
    config_path = "/home/hlj/wekws/wekws/examples/hi_xiaowen/s0/modelzoo/fsmn8_adv_cn/config.yaml"
    checkpoint_path = "/home/hlj/wekws/wekws/examples/hi_xiaowen/s0/modelzoo/fsmn8_adv_cn/72.pt"
    onnx_model_path = "/home/hlj/Hi3519DV500/ModelZoo/wekws/hisi_ctc_cn.onnx"
    ...
    model.eval()
    # dummy_input: (batch, time, feature_dim)
    dummy_input = torch.randn(1, 1, feature_dim, dtype=torch.float)
    cache = torch.zeros(1,
                        128,
                        model.backbone.padding,
                        dtype=torch.float)
